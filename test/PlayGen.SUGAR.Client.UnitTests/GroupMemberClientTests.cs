...
namespace PlayGen.SUGAR.Client.UnitTests
{
	public class GroupMemberClientTests : ClientTestsBase
	{
		...
		public void CanCreateAutoAcceptedRequest()
		{
			...
			Assert.AreEqual(2, received.Items.Count());
		}
		...
		public void CanGetMembers()
		{
			...
			Assert.AreEqual(6, members.Items.Count());
		...
		public void CanGetUserGroups()
		{
			...
			Assert.AreEqual(5, userGroups.Items.Count());

			var groupCheck = userGroups.Items.Where(r => acceptorNames.Any(an => r.Name.Contains(an)));
