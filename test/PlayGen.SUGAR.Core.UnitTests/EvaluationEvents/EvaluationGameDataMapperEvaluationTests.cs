...
namespace PlayGen.SUGAR.Core.UnitTests.EvaluationEvents
{
    ...
    public class EvaluationGameDataMapperEvaluationTests : EvaluationTestsBase
    {
        ...
        {
            // Arrange
            var gameDataMapper = new EvaluationSaveDataMapper();
            var count = 10;
            ...
            foreach (var shouldGetEvaluation in shouldGetEvaluations)
            {
                ...
                {
                    var gameData = Helpers.ComposeSaveData(0, evaluationCriteria, shouldGetEvaluation.GameId);
        ...
        public void RemovesEvaluationsGameDataMapping()
        {
            ...
            {
                var gameData = Helpers.ComposeSaveData(0, evaluationCriteria, removeEvaluation.GameId);
            ...
            foreach (var shouldntRemoveEvaluation in shouldntRemoveEvaluations)
            {
                ...
                {
                    var gameData = Helpers.ComposeSaveData(0, evaluationCriteria, shouldntRemoveEvaluation.GameId);
