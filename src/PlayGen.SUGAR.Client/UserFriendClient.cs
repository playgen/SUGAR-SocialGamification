...
namespace PlayGen.SUGAR.Client
{
	...
	public class UserFriendClient : ClientBase
	{
		...
		public UserFriendClient(string baseAddress, IHttpHandler httpHandler, AsyncRequestController asyncRequestController,
		...
		public void CreateFriendRequestAsync(RelationshipRequest relationship, Action<RelationshipResponse> onSuccess,
			Action<Exception> onError)
		{
		...
		public void UpdateFriendRequestAsync(RelationshipStatusUpdate relationship, Action onSuccess,
			Action<Exception> onError)
		{
