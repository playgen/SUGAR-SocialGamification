...
{
	/// <summary>
	/// Controller that facilitates EvaluationData specific operations.
	/// </summary>
	public class EvaluationDataClient : ClientBase
	{
		private const string ControllerPrefix = "api/gamedata";

		public EvaluationDataClient(string baseAddress, IHttpHandler httpHandler, AsyncRequestController asyncRequestController, EvaluationNotifications evaluationNotifications)
			: base(baseAddress, httpHandler, asyncRequestController, evaluationNotifications)
		{
		}

		/// <summary>
		/// Find a list of all EvaluationData that match the <param name="actorId"/>, <param name="gameId"/> and <param name="key"/> provided.
		/// </summary>
		...
		/// <summary>
		/// Create a new EvaluationData record.
		/// </summary>
		/// <param name="data"><see cref="EvaluationDataRequest"/> object that holds the details of the new EvaluationData.</param>
		/// <returns>A <see cref="EvaluationDataResponse"/> containing the new EvaluationData details.</returns>
