...
namespace PlayGen.SUGAR.Client
{
	...
	public class SkillClient : ClientBase
	{
		...
		public SkillClient(string baseAddress, IHttpHandler httpHandler, AsyncRequestController asyncRequestController,
		...
		/// <summary>
		///     Find a Global Skill that matches
		///     <param name="token" />
		///     .
		/// </summary>
		...
		/// <summary>
		///     Find a list of Skills that match
		///     <param name="gameId" />
		///     .
		/// </summary>
		...
		/// <summary>
		///     Find the current progress for all global skills for
		///     <param name="actorId" />
		///     .
		/// </summary>
		...
		/// <summary>
		///     Find the current progress for all skills for a
		///     <param name="gameId" />
		///     for
		///     <param name="actorId" />
		///     .
		...
		/// <summary>
		///     Find the current progress for an Skill for
		///     <param name="actorId" />
		///     .
		/// </summary>
		/// <param name="token">Token of Skill</param>
