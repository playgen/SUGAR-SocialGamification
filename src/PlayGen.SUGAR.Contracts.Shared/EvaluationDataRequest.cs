...
namespace PlayGen.SUGAR.Contracts
{
	...
	{
		/// <summary>
		///     The id of the Actor which this ActorData/GameData is being ensigned to. Can be left null to ensign to the
		///     system/game.
		/// </summary>
		public int? CreatingActorId { get; set; }

		/// <summary>
		///     The id of the Game which this ActorData/GameData relates to. Can be left null to relate the ActorData/GameData to
		///     the wider system.
		/// </summary>
