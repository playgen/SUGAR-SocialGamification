			...
			switch (saveDataType)
			{
				case SaveDataType.Long:
					results = actors.Select(r => new LeaderboardStandingsResponse
					{
						ActorId = r.Id,
						ActorName = r.Name,
						Value = SaveDataCoreController.GetHighestLong(gameId, r.Id, key, request.DateStart, request.DateEnd).ToString()
					}).ToList();
					break;
				...
				case SaveDataType.Float:
					results = actors.Select(r => new LeaderboardStandingsResponse
					{
						ActorId = r.Id,
						ActorName = r.Name,
						Value = SaveDataCoreController.GetHighestFloat(gameId, r.Id, key, request.DateStart, request.DateEnd).ToString()
					}).ToList();
					break;
			...
			switch (saveDataType)
			{
				case SaveDataType.Long:
					results = actors.Select(r => new LeaderboardStandingsResponse
					{
						ActorId = r.Id,
						ActorName = r.Name,
						Value = SaveDataCoreController.GetLowestLong(gameId, r.Id, key, request.DateStart, request.DateEnd).ToString()
					}).ToList();
					break;
				...
				case SaveDataType.Float:
					results = actors.Select(r => new LeaderboardStandingsResponse
					{
						ActorId = r.Id,
						ActorName = r.Name,
						Value = SaveDataCoreController.GetLowestFloat(gameId, r.Id, key, request.DateStart, request.DateEnd).ToString()
					}).ToList();
					break;
