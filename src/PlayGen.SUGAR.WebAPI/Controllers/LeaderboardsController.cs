...
namespace PlayGen.SUGAR.WebAPI.Controllers
{
	...
	public class LeaderboardsController : Controller
	{
		...
		///     <param name="gameId" />
		///     .
		///     If global is provided instead of a gameId, get all global leaderboards, ie. leaderboards that are not associated
		...
		public IActionResult Get([FromRoute] int? gameId)
		{
			...
			var leaderboardContract = leaderboard.ToCollectionContract();
		...
		public IActionResult GetLeaderboardStandings([FromBody] LeaderboardStandingsRequest leaderboardDetails)
		{
			...
			return new ObjectResult(collectionContract);
		}
