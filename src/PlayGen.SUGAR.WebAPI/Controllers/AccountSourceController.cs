...
namespace PlayGen.SUGAR.WebAPI.Controllers
{
	...
	public class AccountSourceController : Controller
	{
		...
		public IActionResult Get()
		{
			...
			var accountSourceContract = accountSources.ToCollectionContract();
			return new ObjectResult(accountSourceContract);
		}

		/// <summary>
		///     Get AccountSource that matches
		///     <param name="id" />
		///     provided.
		...
		/// </summary>
		/// <param name="newAccountSource">
		///     <see cref="AccountSourceRequest" /> object that contains the details of the new
		///     AccountSource.
		/// </param>
		...
		{
			if (_authorizationService.AuthorizeAsync(User, -1, (AuthorizationRequirement) HttpContext.Items["Requirements"])
				.Result)
			{
