...
namespace PlayGen.SUGAR.WebAPI.Controllers
{
	...
	{
		public SkillsController(EvaluationController evaluationCoreController,
			EvaluationTracker evaluationTracker, IAuthorizationService authorizationService)
		...
		///     <param name="gameId" />
		///     .
		///     If global is provided instead of a gameId, get all global skills, ie. skills that are not associated with a
		///     specific game.
