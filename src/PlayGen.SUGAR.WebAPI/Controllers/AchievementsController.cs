...
namespace PlayGen.SUGAR.WebAPI.Controllers
{
	...
	public class AchievementsController : EvaluationsController
	{
		...
		/// <summary>
		///     Find an Achievement that matches
		///     <param name="token" />
		///     and
		///     <param name="gameId" />
		///     .
		...
		/// </param>
		/// <param>
		///     ID of the Game the Achievement is for
		///     <name>gameId</name>
		/// </param>
		...
		///     <param name="gameId" />
		///     .
		///     If global is provided instead of a gameId, get all global achievements, ie. achievements that are not associated
		...
		public IActionResult GetAchievementProgress([FromRoute] string token, [FromRoute] int? gameId,
		...
		{
			if (_authorizationService.AuthorizeAsync(User, null, (AuthorizationRequirement) HttpContext.Items["Requirements"])
				.Result)
			{
